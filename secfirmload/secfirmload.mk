...
define SECFIRMLOAD_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 755 $(@D)/$(BR2_ARCH)/tee_preload_fw     $(TARGET_DIR)/usr/bin/
	$(INSTALL) -D -m 644 $(@D)/$(BR2_ARCH)/tee_preload_fw.so  $(TARGET_DIR)/usr/lib/
	$(INSTALL) -D -m 644 $(@D)/$(BR2_ARCH)/526fc4fc-7ee6-4a12-96e3-83da9565bce8.ta   $(TARGET_DIR)/lib/teetz/
...
define SECVIDEO_PREBUILT_INSTALL_INIT_SYSV
	$(INSTALL) -D -m 755 $(@D)/S60secload $(TARGET_DIR)/etc/init.d/
endef
endif
